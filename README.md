...
the biggest challege for me was using html! i know a little but about python and javascript from working on some personal projects and robotics, however html was a very different experience.
using vscode i really enjoyed using a extention to allow me to view what i was coding in real time with Live Preview - Microsoft
later i hope to be able to make some websites that are a little more (dark/white, animations), and better coded (neater codebase).
learning to write good README's are a skill and i think i need to get better at using doing them, importantly learning to use the .md file format is something that i will work on!
